...
it('can render comment reply list in auth mode', function () {
    ...
    livewire(ListView::class, ['message' => $comment, 'relatedModel' => $video, 'total' => 1])
        ->call('setShowStatus')
...
it('can render paginated replies list for auth user', function ($count) {
    ...
    livewire(ListView::class, ['message' => $comment, 'relatedModel' => $video, 'total' => $count])
        ->call('setShowStatus')
...
it('can sort comment\'s reply list by latest', function () {
    ...
    livewire(ListView::class, ['message' => $comment, 'relatedModel' => $video, 'total' => 2])
