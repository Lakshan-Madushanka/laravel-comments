...
it('remove already existing like for auth mode', function () {
    ...
    livewire(ReactionsManager::class, ['comment' => $comment, 'guestMode' => true, 'relatedModel' => video(), 'guestMode' => false, 'relatedModel' => video()])
...
it('can create like when already has disliked for auth mode', function () {
    ...
    livewire(ReactionsManager::class, ['comment' => $comment, 'guestMode' => true, 'relatedModel' => video(), 'guestMode' => false])
        ->call('handle', type: 'like')
        ->assertOk();
