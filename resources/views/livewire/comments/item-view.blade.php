...
<div
    ...
    @class([
        'flex gap-x-2 pb-2 sm:gap-x-4 dark:!bg-black dark:!text-white',
        'rounded-lg border p-4' => Helpers::isModernTheme(),
    ])
    @style(['color: ' . config('commenter.secondary_color') . ';' . 'background: ' . config('commenter.bg_secondary_color')])
>
    ...
    >
        ...
        >
            <div
                @class(['hidden rounded-xl md:block md:w-[4%]', '!hidden' => ! Helpers::isModernTheme()])
                @style(['background: ' . config('commenter.bg_primary_color')])
            >
                <div class="flex h-full items-center justify-center font-bold dark:text-black">
                    {{ $comment->score }}
                </div>
            </div>
            ...
            <div @class(['w-full md:w-[96%]' => Helpers::isModernTheme()])>
                <div
                    @class([
                        ...
                        'mb-2 border-b border-gray-100 bg-gray-100 dark:border-slate-900 dark:bg-slate-800' => Helpers::isGithubTheme(),
                    ])
                >
                    <div
                        @class([
                        ...
                        <div class="flex items-center justify-center gap-x-2">
                            ...
                            >
                                ...
                                <ul
                                    ...
                                    x-transition
                                    class="absolute bottom-[1rem] end-[0.8rem] z-10 min-w-32 space-y-1 rounded border bg-white p-1 shadow-lg dark:border-slate-900 dark:bg-slate-800"
                                >
        ...
        <div
            ...
            x-transtion
            @class(['ms-[-2rem] mt-4 sm:ms-4', '!mt-4 sm:!ms-4' => Helpers::isModernTheme()])
        >
            <div
                class="mx-auto mb-6 flex h-[1px] max-w-[100%] items-center justify-center bg-gray-200 bg-gradient-to-r from-transparent via-gray-100 to-transparent"
            ></div>
