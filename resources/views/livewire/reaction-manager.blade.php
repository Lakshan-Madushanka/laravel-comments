    ...
    <div class="flex w-full justify-between gap-x-4 no-dark:text-white!">
        ...
        >
            ...
            @if ($enableReply)
                <div
                    ...
                    @reply-created-{{$message->getKey()}}.window="
                     ...
                     "
                    @class([
                        "px-1 rounded-sm no-dark:bg-slate-800! no-dark:border-slate-700",
            ...
            @if($shouldEnableShareButton)
                <div
                    ...
                    @class([
                        "px-1 rounded-sm no-dark:bg-slate-800! no-dark:border-slate-700 relative gap-2",
                        "rounded-[1000px]! py-1! px-2! bg-transparent" =>  Helpers::isModernTheme(),
                         "hover:!bg-["  . config('commenter.hover_color') . "]" => Helpers::isGithubTheme() || Helpers::isModernTheme(),
                    ])
                    @style([
        ...
        <div
            @class([
                  ...
                  "border border-gray-200 bg-white no-dark:bg-slate-800! no-dark:border-slate-700" => Helpers::isGithubTheme(),
                  "rounded-lg max-w-44! sm:max-w-40! md:max-w-72! bg-transparent no-dark:bg-slate-800! no-dark:border-slate-700" =>  Helpers::isModernTheme()
                ])
        >
                    ...
                    <div class="space-y-2 border-r-2 border-gray-200 no-dark:border-slate-900">
                        ...
                        @foreach (config("commenter.reactions") as $key => $reaction)
                            <div
                                ...
                                @click="type = '{{ $key }}'"
                                @class([
                                    "cursor-pointer p-4 relative hover:bg-gray-300 no-dark:hover:bg-slate-700",
                                    "hover:!bg-["  . config('commenter.hover_color') . "]",
                                ])
                                @endif
