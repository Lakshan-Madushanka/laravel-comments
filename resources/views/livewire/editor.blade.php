<div>
    <div wire:ignore class="relative dark:bg-black dark:text-white">
        <div @click.stop id="{{ $editorId }}" class="pointer-events min-h-32 rounded rounded-t-none"></div>
    ...
    @script
        <script>
            ...
            Livewire.on('user-selected-' + $wire.editorId, () => onMentionedUserSelected(event, quill, editorElm));
