...
<svg viewBox="0 0 21 21" class="w-8" xmlns="http://www.w3.org/2000/svg" fill="#000000">
    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
        <g fill="none" fill-rule="evenodd" stroke="{{config('commenter.primary_color')}}" class="dark:!fill-red-500" stroke-linecap="round" stroke-linejoin="round"
